...
public class PreviewControlFragment extends Fragment {
    private static final String LOGTAG = LiveVideoTestingUsingFirebase.class.getName();

    private LiveVideoTestingUsingFirebase mActivity;
    ...
    public void onAttach(Context context) {
        ...
        this.mActivity = (LiveVideoTestingUsingFirebase) context;
    ...
    public void onAttach(Activity activity) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.M) {
            ...
            this.mActivity = (LiveVideoTestingUsingFirebase) activity;
